...
docker run \
-e APP_PORT=8001 \
-e CONFIG_FILE=/usr/task_planner/task_planner/test/test_config.yaml \
-e STATIC_DIR=/usr/task_planner/task_planner/static \
-e TEMPLATES_DIR=/usr/task_planner/task_planner/templates \
-v $(pwd)/task_planner/configs/config.yaml:/usr/task_planner/task_planner/test/test_config.yaml \
